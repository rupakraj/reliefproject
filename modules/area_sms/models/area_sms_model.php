...
class Area_sms_model extends MY_Model
{
    var $fields = '';
	var $joins  = array();
    ...
    public function __construct()
    {
		...
		$this->_JOINS  = array(
                            'DISTRICT' => array(
                                        'join_type'  => 'LEFT',
                                        'join_field' => 'districts.id=areas_sms.district',
                                        'select'     => 'districts.name_en as district_name',
                                        'alias'      => 'districts'
                                    ),
                            'ACCESSIBILITIES' => array(
                                'join_type'  => 'LEFT',
                                'join_field' => 'accessibilities.id=areas_sms.accessibility_id',
                                'select'     => 'accessibilities.name as accessibility_name',
                                'alias'      => 'accessibilities'
                            ),
                            'AREATYPES' => array(
                                'join_type'  => 'LEFT',
                                'join_field' => 'areatypes.id=areas_sms.area_type',
                                'select'     => 'areatypes.name as area_type_name',
                                'alias'      => 'areatypes'
                            ),
                            'OBSTRUCTIONS' => array(
                                'join_type'  => 'LEFT',
                                'join_field' => 'obstructions.id=areas_sms.road_obstruct_detail',
