...
<br/>
<table id="page-table" pagination="true" title="<?php echo lang('page')?>" pagesize="20" rownumbers="true" toolbar="#toolbar" collapsible="true" fitColumns="true">
    <thead>
    <th field="checkbox" checkbox="true"></th>
    <th field="page_title" sortable="true" width="50" formatter="formatLink"><?php echo lang('page_title')?></th>
    <th field="image_name" sortable="true" width="50" formatter="formatImage"><?php echo lang('image_name')?></th>
    ...
    <table>
		<tr>
               ...
               <tr>
					  ...
					  <td width="66%"><input type="radio" name="status" id="status1" value="1"/><?php echo lang("general_yes")?> <input type="radio" name="status" id="status0" value="0"/><?php echo lang("general_no")?></td>
...
<script language="javascript" type="text/javascript">
	...
	function getActions(value,row,index)
	{
		...
		var d = '<a href="#" onclick="removePage('+index+')" class="easyui-linkbutton l-btn" iconcls="icon-remove"  title="<?php echo lang('delete_page')?>"><span class="l-btn-left"><span style="padding-left: 20px;" class="l-btn-text icon-cancel"></span></span></a>';
		return e+d;		
	}
	
	function formatImage(value)
	{
		var i='<img src="<?php echo base_url()?>uploads/page/thumb/'+value+'" border="0" height="100" width="100"/>';
