...
//$config['asset'][] = array('file' => 'jqwidgets/jqx-all.js', 'needs' => 'jquery.js', 'name' => 'jqx.all.js', 'position' => 'header');
...
//$config['asset_group']['JQWIDGETS'] = 'jqx.base.css|jqx.theme.css|jqx.base.extended.css|jqx.all.js';
