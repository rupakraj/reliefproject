...
class Settings extends Admin_Controller
{
	...
	function index()
	{
		...
		$config['form_link'] = 'admin/auth/settings/index';
		...
		$config['group'] = array(
                ...
                'users'       => array('name'=> $this->lang->line('preference_page_user_settings'), 'fields'=>'allow_user_registration,activation_method,account_activation_time,autologin_period,default_user_group,login_field,allow_user_profiles'),
		...
		//$config['field']['default_folder_location'] = array('rules'=>'trim|required');
