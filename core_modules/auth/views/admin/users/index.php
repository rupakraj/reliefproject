	...
	<section class="content">
		...
		<div class="row">
			<div class="col-xs-12 connectedSortable">
				...
				<button type="button" class="btn btn-primary btn-flat btn-xs" id="jqxGridUsersCreate" onClick="location.href='<?php echo site_url('admin/auth/users/form');?>'"><?php echo lang('create'); ?></button>
				<button type="button" class="btn btn-danger btn-flat btn-xs" id="jqxGridUsersFilterClear"><?php echo lang('clear');?></button>
