                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-body">
                            ...
                            <input type="hidden" value="<?php echo $this->session->userdata('organization_id') ?>" name="organization_id" id="organization_id" />
                            <?php else:?>
                            <div class="form-group">
                                <label for="group">Organization</label>
                                <?php print form_dropdown('organization_id', $organizations, $this->validation->organization_id,'id="organization_id" class="form-control"')?>
                            </div>
                            <?php endif;?>
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-primary btn-flat btn-xs no-shadow" href="<?php print site_url('admin/auth/users')?>" >
