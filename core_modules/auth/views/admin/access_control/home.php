        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xs-6">
                ...
                <div class="small-box">
                    ...
                    <a href="<?php echo site_url('admin/auth/permissions');?>" class="small-box-footer bg-blue" style="text-align:right">
            ...
            <div class="col-lg-6 col-xs-6">
                ...
                <div class="small-box">
                    ...
                    <a href="<?php echo site_url('admin/auth/groups');?>" class="small-box-footer bg-blue" style="text-align:right">
                        Open &nbsp;&nbsp;<i class="fa fa-folder-open" style="margin-right:5px"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xs-6">
                ...
                <div class="small-box">
                    ...
                    <a href="<?php echo site_url('admin/auth/resources');?>" class="small-box-footer bg-blue" style="text-align:right">
                        Open &nbsp;&nbsp;<i class="fa fa-folder-open" style="margin-right:5px"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
                ...
                <div class="small-box">
                    ...
                    <a href="<?php echo site_url('admin/auth/actions');?>" class="small-box-footer bg-blue" style="text-align:right">
                        Open &nbsp;&nbsp;<i class="fa fa-folder-open" style="margin-right:5px"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-xs-6">
                ...
                <div class="small-box">
                    ...
                    <a href="<?php echo site_url('admin/auth/actions');?>" class="small-box-footer bg-blue">
                        Open &nbsp;&nbsp;<i class="fa fa-folder-open" style="margin-right:5px"></i>
                    </a>
                </div>
            </div>
